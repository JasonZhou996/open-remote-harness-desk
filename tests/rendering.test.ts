...
import { agentMessageText, isImageReference, itemImageReferences, localDownloadUrl, localImageUrl, parseFileReference, renderAssistantMarkdown, renderItemImages } from "../web/codex/rendering.js";
...
describe("assistant Markdown and LaTeX rendering", () => {
  ...
  test("renders file citations separately from external links", () => {
    const html = renderAssistantMarkdown("Changed [app.js](/Users/home/Projects/codex-webui/web/codex/app.js:186-199) and [docs](https://example.com/docs).");
    expect(parseFileReference("/Users/home/Projects/codex-webui/web/codex/app.js:186-199")).toEqual({ path: "/Users/home/Projects/codex-webui/web/codex/app.js", lineStart: 186, lineEnd: 199 });
    expect(parseFileReference("https://example.com/docs")).toBeNull();
    expect(html).toContain('class="file-citation"');
    expect(html).toContain('data-file-reference="/Users/home/Projects/codex-webui/web/codex/app.js"');
