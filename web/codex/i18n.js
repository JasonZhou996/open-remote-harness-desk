// App-owned server messages only. Model text and external errors remain unchanged.
export const uiErrorTranslations = {
  'This question has already been answered or expired. Refresh the conversation.': '此问题已回答或已失效，请刷新会话',
  'The desktop conversation is unavailable.': '桌面会话当前不可用',
  'The desktop conversation is unavailable. Keep the desktop app open.': '桌面会话当前不可用，请保持客户端打开',
  'The service restarted. Check the conversation before resending.': '服务已重启，上一条发送结果待确认，请先核对会话。',
  'The send receipt expired. Check the conversation before resending.': '发送回执已过期，请先核对会话。',
  'Claude service unavailable': 'Claude 服务不可用',
  'Each attachment must be 25 MB or smaller.': '单个附件不能超过 25 MB',
  'This message has left the queue. Check the conversation.': '该消息已离开队列，请查看对话',
  'This message was edited on another device. Cancel editing and reopen it.': '该消息已在另一端修改，请取消编辑后重新打开',
  'The message cannot be empty.': '消息不能为空',
  'Steering now': '正在立即插入',
  'Steering is unconfirmed. Check the conversation before retrying.': '插入未确认，请核对对话后重试',
  'This file exceeds 2 MB. Download it to view it.': '文件超过 2 MB，请下载查看',
  'Download this file to view it.': '此文件格式请下载查看',
  'Permissions are being changed. Please try again shortly.': '正在切换权限，请稍后重试。',
  'This turn has ended. Select permissions again.': '本轮已结束，请重新选择权限。',
  'Choose Claude Code or Codex.': '请选择 Claude Code 或 Codex',
  'The service restarted and interrupted the import. Please retry.': '服务已重启，导入中断，请重试',
  'Choose a project first.': '请先选择项目',
  'Invalid source conversation': '来源会话无效',
  'Invalid import request': '导入请求无效',
  'Two imports are already running. Please try again shortly.': '已有两个导入正在进行，请稍后再试',
  'The source conversation is outside this project or has been removed.': '来源会话不属于当前项目，或已被移除',
  'transession is not installed. Run npm run install:converter.': '尚未安装 transession，请运行 npm run install:converter',
  'Invalid source conversation file': '来源会话文件无效',
  'The conversation is empty or exceeds the 64 MB import limit.': '会话为空或超过 64 MB 导入上限',
  'The source conversation has no complete records.': '来源会话没有完整记录',
  'No user messages available to import.': '没有可导入的用户消息',
  'The destination could not read the imported history.': '目标端没有读到导入历史',
  'This request is not supported in the page preview.': '当前网页预览不支持此请求。',
  'This website has an invalid security certificate. Check the address.': '此网站的安全证书无效，请检查网址。',
  'Could not connect to the website. Check the address or try again later.': '无法连接网站，请检查网址或稍后重试。',
  'Import in progress': '导入进行中',
};
const english = Object.fromEntries(Object.entries(uiErrorTranslations).map(([en, zh]) => [zh, en]));
export const englishUiError = message => Object.hasOwn(english, message) ? english[message] : typeof message === 'string' ? message.replace(/^网站返回错误（HTTP (\d+)）。$/, 'Website returned an error (HTTP $1).') : message;
...
Object.assign(ZH_CN, uiErrorTranslations, {
  "Upload file": "上传文件",
  "Connection interrupted or request timed out. Resyncing.": "连接中断或请求超时，正在重新同步。",
  "Request timed out. Resyncing.": "请求超时，正在重新同步。",
  "Usage API HTTP {value0}": "额度接口 HTTP {value0}",
  "Weekly quota": "周额度",
  "5-hour quota": "5 小时额度",
  "{value0}-hour quota": "{value0} 小时额度",
  "Quota": "额度",
  "{value0}{value1}: {value2}% remaining": "{value0}{value1}：剩余 {value2}%",
  "Resets {value0}": "{value0} 重置",
  "View usage": "查看额度",
  "{value0}% weekly quota remaining": "周剩余 {value0}%",
  "No usage data yet": "暂无额度数据",
  "Last updated: {value0}": "上次更新：{value0}",
  "Click to retry": "点击重试",
  "Reset thinking effort": "恢复默认思考强度",
  "Read-only": "只读",
  "Collapse": "收起",
  "Expand": "展开显示",
  "Recents": "最近",
  "Showing cached messages. Syncing latest messages…": "已显示本地缓存，正在同步最新消息…",
  "Loading import status…": "正在读取导入状态…",
  "Showing cached messages. Could not sync the latest messages.": "已显示本地缓存；最新消息同步失败。",
  ...
  "Loading installed skills…": "正在读取已安装的 Skill…",
  "Attached files (uploaded by the user):\n": "附加文件（用户上传）：\n",
  "Attachments are uploading. Please wait before adding more.": "附件正在上传，请稍候再添加",
  "{value0} exceeds 25 MB": "{value0} 超过 25 MB",
  "Uploading {value0}": "正在上传 {value0}",
  "Upload failed": "上传失败",
  "Add files or photos": "添加文件或图片",
  "Attachments are uploading": "附件正在上传",
  "Connection is not ready. Please try sending shortly.": "连接尚未就绪，请稍后发送。",
  "Conversation changed. Confirm sending in the original conversation.": "会话已切换，请在原会话确认发送。",
  "Send receipt not received. Syncing; resending will check the same request.": "发送回执未收到，正在同步；再次发送会核对同一条请求。",
  "Add to queue": "加入队列",
  "Could not open the save dialog:": "无法打开保存窗口：",
  "Loading directory…": "正在读取目录…",
  "This directory is empty": "此目录为空",
  "Loading file…": "正在读取文件…",
  "Enlarge page {value0}": "放大第 {value0} 页",
  "{value0} · Page {value1}": "{value0} · 第 {value1} 页",
  "Page {value0} failed to load. Click to retry.": "第 {value0} 页加载失败，点击重试",
  "Restore automatic layout": "恢复自动布局",
  "Force desktop layout": "强制使用桌面布局",
  "Choose or enter an answer": "请选择或填写答案",
  "Invalid answer format": "答案格式无效",
  "The questions have changed. Refresh and try again.": "问题已变化，请刷新后重试",
  "Please answer every question": "请回答每个问题",
  "Your input is needed": "需要你确认",
  "Add details or enter another answer": "补充或填写其他答案",
  "Your answer": "你的答案",
  "An entered answer overrides the selected option": "填写后以此答案为准",
  "Enter an answer": "输入答案",
  "Submit answers": "提交答案",
  "Submitted": "已提交",
  "Submitting…": "提交中…",
  "Submission failed. Please try again.": "提交失败，请重试",
  "Search skills": "搜索 Skill",
  "Close current tool tab": "关闭当前工具标签",
  "Resize side panel": "调整右栏宽度",
  "Close new tab": "关闭新标签页",
  "Close review tab": "关闭审阅标签",
  "Shared desktop conversation": "共享桌面会话",
  "Upload folder": "上传文件夹",
  "Close side panel": "收起右侧栏",
  "Loading…": "读取中…",
  "Add content": "添加内容",
...
const ZH_CN_PATTERNS = [
  [/^Website returned an error \(HTTP (\d+)\)\.$/, match => `网站返回错误（HTTP ${match[1]}）。`],
  [/^Usage API HTTP (.+?)$/, match => `额度接口 HTTP ${match[1]}`],
  [/^(.+?)-hour quota$/, match => `${match[1]} 小时额度`],
  [/^Resets (.+?)$/, match => `${match[1]} 重置`],
  [/^(.+?)% weekly quota remaining$/, match => `周剩余 ${match[1]}%`],
  [/^Last updated: (.+?)$/, match => `上次更新：${match[1]}`],
  [/^(.+?) exceeds 25 MB$/, match => `${match[1]} 超过 25 MB`],
  [/^Uploading (.+?)$/, match => `正在上传 ${match[1]}`],
  [/^Enlarge page (.+?)$/, match => `放大第 ${match[1]} 页`],
  [/^(.+?) · Page (.+?)$/, match => `${match[1]} · 第 ${match[2]} 页`],
  [/^Page (.+?) failed to load\. Click to retry\.$/, match => `第 ${match[1]} 页加载失败，点击重试`],
  [/^Import a conversation from (.+?)$/, match => `从 ${match[1]} 导入对话`],
  [/^Import from (.+?)$/, match => `从 ${match[1]} 导入`],
  [/^(.+): (\d+)% remaining$/, match => `${match[1].split(" · ").map(part => translate(part, "zh-CN")).join(" · ")}：剩余 ${match[2]}%`],
...
export function createDomI18n(i18n, { root = globalThis.document } = {}) {
  ...
  function translateSubtree(node) {
    if (!node || (isExcluded(node) && !node.querySelector?.('[data-i18n-ui]'))) return;
    if (node.nodeType === 3) {
    ...
    const walker = root.createTreeWalker(node, NodeFilterApi.SHOW_ELEMENT | NodeFilterApi.SHOW_TEXT, {
      acceptNode(current) {
        if (current.nodeType === 1 && isExcluded(current)) {
          return current.querySelector('[data-i18n-ui]') ? NodeFilterApi.FILTER_SKIP : NodeFilterApi.FILTER_REJECT;
        }
  ...
  const observer = MutationObserverApi ? new MutationObserverApi(records => {
    const added = new Set(records.flatMap(record => [...record.addedNodes]));
    ...
    for (const node of added) {
      ...
      if (!parent) translateSubtree(node);
    }
  }) : null;
