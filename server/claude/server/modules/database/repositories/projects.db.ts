...
/** Projects' instruction watcher follows registration/archive changes without polling the database. */
export const projectChanges = new EventEmitter();
